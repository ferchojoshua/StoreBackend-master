...
namespace Store.Migrations
{
    ...
    [Migration("20220706165652_AddContabilidad10")]
    partial class AddContabilidad10
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Store.Entities.ProductMovmentDetails", b =>
                {
                    ...
                    b.Property<int?>("ProductMovmentsId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("StoreBackend.Entities.CountFuentesContables", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("FuentesContables");
                });

            modelBuilder.Entity("StoreBackend.Entities.CountLibros", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Store.Entities.ProductMovmentDetails", b =>
                {
                    b.HasOne("Store.Entities.ProductMovments", null)
                        .WithMany("MovmentDetails")
                        .HasForeignKey("ProductMovmentsId");
